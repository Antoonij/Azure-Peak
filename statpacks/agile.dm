...
/datum/statpack/agile/swift
	...
	stat_array = list(STAT_SPEED = 2, STAT_CONSTITUTION = 1, STAT_WILLPOWER = -1, STAT_PERCEPTION = -1)
...
/datum/statpack/agile/dextrous
	...
	stat_array = list(STAT_SPEED = 2, STAT_PERCEPTION = 1, STAT_CONSTITUTION = -1, STAT_INTELLIGENCE = -2)
